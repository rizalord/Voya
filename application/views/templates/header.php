    ...
    <div class="navbar">
        ...
        <div class="user">
            ...
            <?php if (isset($profile_url)) {
                ...
                echo base_url('assets/img/logo/defaultUser.jpg');
            }
            ?>">
        </div>
        ...
        <div class="userNav">
            ...
            <div class="imageProfile">
                <img class="imgUser" src="<?php if (isset($profile_url)) echo $profile_url; ?>">
                <div class="nameUser">
                    <p class="userNamee text-truncate"><?php if (isset($name)) echo $name; ?></p>
                </div>
            </div>
            <?php } ?>
